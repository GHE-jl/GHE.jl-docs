...
- **Dion, G., Pasquier, P., Marcotte, D., & Beaudry, G.** (2023). Multi-deconvolution in
  ...
  Source of the multi-objective weighting scheme balancing the temperature-misfit, first-, and
...
- **Marcotte, D., & Pasquier, P.** (2008). Fast fluid and ground temperature computation for
  ...
  Non-circular convolution scheme underlying `convolution`, the same scheme
  `GroundHeatExchanger.jl` uses internally.
